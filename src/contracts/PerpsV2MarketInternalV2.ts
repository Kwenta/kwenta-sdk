...
import PerpsV2Market from '../contracts/abis/PerpsV2Market.json';
...
class FuturesMarketInternal {
	...
	constructor(sdk: KwentaSDK, marketKey: FuturesMarketKey, marketAddress: string) {
		this._provider = sdk.context.provider;
		this._sdk = sdk;

		this._perpsV2MarketContract = PerpsV2Market__factory.connect(
			marketAddress,
