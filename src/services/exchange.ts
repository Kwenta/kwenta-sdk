...
import { ATOMIC_EXCHANGE_SLIPPAGE, CG_BASE_API_URL } from '../constants/exchange';
import { PriceResponse } from '../types/exchange';
import { getProxySynthSymbol } from '../utils/synths';
...
import { UNIT_BIG_NUM, zeroBN } from '../utils/number';
