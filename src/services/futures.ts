...
import { getFuturesAggregateStats } from '../types/subgraph';
...
import { NetworkOverrideOptions } from '../types/common';
import {
	FundingRateInput,
	FundingRateResponse,
	FundingRateUpdate,
...
export default class FuturesService {
	...
	private getInternalFuturesMarket(marketAddress: string, marketKey: FuturesMarketKey) {
		...
		market = new PerpsV2MarketInternal(this.sdk, marketKey, marketAddress);
