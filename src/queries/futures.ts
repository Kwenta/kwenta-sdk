...
import { FuturesAccountType, getFuturesPositions, getFuturesTrades } from '../types/subgraph';
import { SMART_MARGIN_FRAGMENT, ISOLATED_MARGIN_FRAGMENT } from '../constants/futures';
