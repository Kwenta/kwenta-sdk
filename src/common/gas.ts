...
import { weiFromWei, zeroBN } from '../utils/number';
...
export const getGasPriceFromProvider = async (provider: Provider) => {
	try {
...
export const getEthGasPrice = async (networkId: NetworkId, provider: Provider) => {
	try {
